...
### 2025年1月更新
- **重大介面更新**：
  - **移除側邊欄**：完全移除右側的側邊欄及其切換按鈕。
  - **標頭登入**：將登入功能整合至右上角的用戶菜單中，簡化整體佈局。
- **術語更新**：將所有「Announcements」和「Club Announcements」更改為「Activity News」。
- **介面優化**：
  - 調整 MMW Hubix 標誌的右邊距，改善視覺平衡。
  - 簡化頁腳網站地圖，移除多餘的管理功能區塊。
- **管理後台簡化**：
  - 移除管理儀表板的「待辦事項」、「最近活動」和「快速操作」區塊。
  - 移除儀表板側邊欄的「分析」和「日誌」導航連結。
- **浮動聊天泡泡（Chat Bubble）啟動器**：AI 助手的聊天視窗現在由右下角的浮動按鈕啟動。
# MMW Hubix - 學校資訊門戶網站
...
- IT 技術支援
- 課程表和重要日期查詢
- 新增：以「右下角浮動圓形按鈕」開啟聊天視窗（取代側邊欄卡片內的聊天框）。
